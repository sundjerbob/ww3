/*
 * LIGHTING FRAGMENT SHADER - Advanced Lighting Calculations with Shadow Mapping
 * 
 * PURPOSE:
 * Calculates final fragment color using multiple lighting models with shadow mapping.
 * Supports ambient, directional, and point lighting with material properties and shadows.
 * 
 * LIGHTING MODELS:
 * - Ambient: Global illumination (constant)
 * - Directional: Sun/moon lighting (directional) with shadows
 * - Point: Local light sources (position-based with attenuation)
 * 
 * MATERIAL PROPERTIES:
 * - Ambient: How much ambient light the material reflects
 * - Diffuse: How much directional light the material reflects
 * - Specular: How much specular reflection the material has
...
// Light arrays (with limits for shader compatibility)
